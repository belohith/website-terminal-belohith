...
textArea.addEventListener("keydown", function (event) {
  ...
  `;
      ...
      case "about":
        ...
        <br>Certifications: <br><br> Google UI UX Design Professional Certificate - <a  target="_blank" href="https://www.coursera.org/account/accomplishments/professional-cert/QLMAEPEF32W5"> View Certificate </a> <br>
  ...
  `;
      ...
      case "creative-projects":
        ...
        <tr><td>Waiting in Bangalore: Part 1</td><td><a href="https://www.amazon.com/Waiting-Bangalore-Part-Lohith-Bollineni/dp/B09NRHKHFX/ref=tmm_pap_swatch_0?_encoding=UTF8&qid=&sr=" class="link" target= "_blank">Buy</a></td><td>Book</td><td>This is a fictional story about people in their 20s living in Bangalore. It is based on my experience when I was in Bangalore and all the different people that I got to meet then. More parts coming soon.</td><td>06 Jun 2020</td><td>Writing · Editing</td></tr>
        ...
        <tr><td>Digital Portraits</td><td><a href="https://www.belohith.com/creative" class="link" target= "_blank">Link</a></td><td>Design</td><td>Digital Portaits of various people that I have drawn over the years.</td><td class="na">N/A</td><td>Adobe Illustrator</td></tr>
        <tr><td>UI UX</td><td><a href="https://https://www.belohith.com/tech/#uiux-projects" class="link" target= "_blank">Link</a></td><td>Design</td><td>UI UX case studies that I have worked on. (web & mobile apps)</td><td class="na">N/A</td><td>Adobe XD · Figma · Sketch · Adobe Photoshop · Adobe Illustrator</td></tr>
        <tr><td>Logos</td><td><a href="https://https://www.belohith.com/creative" class="link" target= "_blank">Link</a></td><td>Design</td><td>Logos I have created over the years.</td><td class="na">N/A</td><td>Adobe Illustrator · Adobe Photoshop · Canva</td></tr>
        <tr><td>Posters</td><td><a href="https://https://www.belohith.com/creative" class="link" target= "_blank">Link</a></td><td>Design</td><td>Posters I have created over the years.</td><td class="na">N/A</td><td>Adobe Illustrator · Adobe Photoshop · Canva</td></tr>
        <tr><td>Typography</td><td><a href="https://https://www.belohith.com/creative" class="link" target= "_blank">Link</a></td><td>Design</td><td>Typography projects and Fonts that I created over the years.</td><td class="na">N/A</td><td>Adobe Illustrator · Adobe Photoshop · Canva</td></tr>
        <tr><td>Photography</td><td><a href="https://https://www.belohith.com/creative" class="link" target= "_blank">Link</a></td><td>Filming</td><td>Photographs clicked on various occasions over the years: for clients, travel, portaits etc.</td><td class="na">N/A</td><td>Photography · Adobe Lightroom · Adobe Photoshop · Canva </td></tr>
